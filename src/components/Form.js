        ...
        <div className=" bg-white px-10 py-20 rounded-3xl border-2 border-gray-200">
            ...
            <div className=" mt-8 " >
                <div>
                    ...
                    <input
                        className=" w-full border-2 border-gray-100 rounded-xl p-5 mt-1 bg-transparent"
                        type="email"
                ...
                <div className="mt-8 flex flex-col gap-y-4" >
                    <button class="btn btn-active btn-primary">LOGIN</button>
                    <button class="btn btn-active btn-primary">CREATE A NEW ACCOUNT</button>
                    <button
